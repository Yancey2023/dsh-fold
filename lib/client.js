  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    if (loneMissingOfficial) {
      ...
      const groupSmall = React6.createElement(
        ...
        React6.createElement(GroupBar, { group: inlineGroup, expanded, onToggle: toggle, onKeyDown, t, live }),
        expanded ? React6.createElement(GroupItems, { group: inlineGroup, t, conversationT: conversationT2 }) : null
      );
      const first = node.key === turnInfo?.firstKey;
      if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
...
function apply(ctx) {
  ...
  if (locale !== void 0) setConversationT(locale.bind("conversation"));
