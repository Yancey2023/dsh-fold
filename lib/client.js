  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
      ...
      if (!turnExpanded) {
        ...
        const groupSmall = leaderSeat ? buildGroupSmall() : React6.createElement(FoldedSeat3, null);
        output = React6.createElement(React6.Fragment, null, first ? React6.createElement(TurnFoldBar, { expanded: true, onToggle: turnToggle, onKeyDown: turnKeyDown, t }) : null, groupSmall);
      }
