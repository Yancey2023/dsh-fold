  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
      ...
      if (!turnExpanded) {
        ...
        const groupSmall = leaderSeat ? buildGroupSmall() : React5.createElement(FoldedSeat2, null);
        output = React5.createElement(React5.Fragment, null, first ? React5.createElement(TurnFoldBar, { expanded: true, onToggle: turnToggle, onKeyDown: turnKeyDown, t }) : null, groupSmall);
      }
