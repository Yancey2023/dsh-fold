...
var ToolCallGroupView = React3.memo(function ToolCallGroupView2(props) {
  ...
  if (group === null || !isGroupLeader(group, node.key)) {
    ...
    output = React3.createElement(
      ...
      expanded ? React3.createElement(GroupItems, { group, t, renderSlot, selectedCallId, cwd, openFile, loadImage, inspectCall, conversationT: conversationT2 }) : null
    );
  }
...
var NoticeNodeWrapper = React4.memo(function NoticeNodeWrapper2(props) {
  ...
  const { chat, hasMore, loadingOlder } = useSnapshotFace(props);
  const inlineGroup = React4.useMemo(
  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    output = official !== void 0 && official.component != null && conversationT2 !== void 0 ? React4.createElement(official.component, { node, t: conversationT2 }) : React4.createElement(FoldedSeat2, null);
    ...
    if (g.count === 1 && (official === void 0 || official.component == null)) {
      ...
      output = React4.createElement(
        ...
        React4.createElement(GroupBar, { group: g, expanded, onToggle: toggle, onKeyDown, t, live }),
        expanded ? React4.createElement(GroupItems, { group: g, t, conversationT: conversationT2 }) : null
      );
    }
  }
