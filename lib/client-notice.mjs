...
var RetryItem = React4.memo(function RetryItem2({ item, conversationT: conversationT2 }) {
...
var GroupItems = React4.memo(function GroupItems2(props) {
  ...
  return React4.createElement(
    ...
    group.items.map((item) => {
      ...
      if (item.kind === "retry") {
        return React4.createElement(RetryItem, { key: item.key, item, conversationT: conversationT2 });
      }
...
var NoticeNodeWrapper = React5.memo(function NoticeNodeWrapper2(props) {
  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    if (!isGroupLeader(retryGroup, node.key)) {
      ...
      const groupSmall = React5.createElement(
        "div",
        { className: "dshToolGroup", "data-tool-group": "", "data-notice": "" },
        React5.createElement(GroupBar, { group: retryGroup, expanded, onToggle: toggle, onKeyDown, t, live }),
        expanded ? React5.createElement(GroupItems, { group: retryGroup, t, conversationT: conversationT2 }) : null
      );
      const first = node.key === turnInfo?.firstKey;
      if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
        output = turnExpanded ? React5.createElement(React5.Fragment, null, first ? React5.createElement(TurnFoldBar, { expanded: true, onToggle: turnToggle, onKeyDown: turnKeyDown, t }) : null, groupSmall) : first ? React5.createElement(TurnFoldBar, { expanded: false, onToggle: turnToggle, onKeyDown: turnKeyDown, t }) : React5.createElement(FoldedSeat2, null);
      } else {
        output = groupSmall;
      }
    }
    ...
    if (officialContent === null) {
      ...
      const bar = React5.createElement(GroupBar, { group, expanded, onToggle: toggle, onKeyDown, t, live });
      const notice = React5.createElement(
        "div",
        { className: "dshToolGroup", "data-tool-group": "", "data-notice": "" },
        bar,
