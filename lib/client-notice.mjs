...
var NoticeNodeWrapper = React5.memo(function NoticeNodeWrapper2(props) {
  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    output = official !== void 0 && official.component != null && conversationT2 !== void 0 ? React5.createElement(official.component, { node, t: conversationT2 }) : React5.createElement(FoldedSeat2, null);
  } else {
    if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
      const first = node.key === turnInfo.firstKey;
      if (!turnExpanded) {
