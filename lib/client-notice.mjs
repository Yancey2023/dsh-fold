...
var NoticeNodeWrapper = React5.memo(function NoticeNodeWrapper2(props) {
  ...
  if (!NOTICE_KINDS.has(node.kind)) {
    ...
    const loneMissingOfficial = inlineGroup.count === 1 && (official === void 0 || official.component == null);
    if (loneMissingOfficial) {
      ...
      const groupSmall = React5.createElement(
        ...
        React5.createElement(GroupBar, { group: inlineGroup, expanded, onToggle: toggle, onKeyDown, t, live }),
        expanded ? React5.createElement(GroupItems, { group: inlineGroup, t, conversationT: conversationT2 }) : null
      );
      const first = node.key === turnInfo?.firstKey;
      if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
