...
function latestActiveNode(snapshot) {
...
var GroupBar = React4.memo(function GroupBar2({ group, expanded, onToggle, onKeyDown, t, cwd, live }) {
  const liveShown = live !== void 0 && !expanded;
  const liveNode = liveShown ? React4.createElement(LiveRow, { node: live, cwd, t }) : null;
  const ownsLive = live !== void 0 && group.itemKeys.includes(live.key);
...
var ToolCallGroupView = React4.memo(function ToolCallGroupView2(props) {
  ...
  if (group === null || !isGroupLeader(group, node.key)) {
    ...
    const small = React4.createElement(
      "div",
      { className: "dshToolGroup", "data-tool-group": "", "data-state": live !== void 0 && group.itemKeys.includes(live.key) && !expanded ? "running" : "settled" },
...
var AssistantNodeWrapper = React5.memo(function AssistantNodeWrapper2(props) {
  ...
  const thinkContent = group !== null && isGroupLeader(group, node.key) ? React5.createElement(
    React5.Fragment,
    null,
    React5.createElement(GroupBar, { group, expanded, onToggle: toggle, onKeyDown, t, live }),
