...
var LiveRow = React4.memo(function LiveRow2({ item, cwd, t }) {
  let icon;
  let title;
  let summary;
  if (item.kind === "think") {
  ...
  return React4.createElement(
    React4.Fragment,
    null,
    React4.createElement("span", { className: "dshToolGroupVisuallyHidden" }, t("running")),
...
var GroupBar = React4.memo(function GroupBar2({ group, expanded, onToggle, onKeyDown, t, cwd }) {
  const runningItem = group.runningItem;
  const live = runningItem === void 0 ? null : React4.createElement(LiveRow, { item: runningItem, cwd, t });
  const chevron = React4.createElement(expanded ? IconChevronDownOutline14 : IconChevronRightOutline14, {
    className: "dshToolGroupChevron"
  });
  return React4.createElement(
    ...
    React4.createElement("div", { className: "dshToolGroupLeft" }, live),
    React4.createElement(
      "div",
...
var ToolCallGroupView = React4.memo(function ToolCallGroupView2(props) {
  ...
  if (group === null || !isGroupLeader(group, node.key)) {
    ...
    const small = React4.createElement(
      ...
      React4.createElement(GroupBar, { group, expanded, onToggle: toggle, onKeyDown, t, cwd }),
      expanded ? React4.createElement(GroupItems, { group, t, renderSlot, selectedCallId, cwd, openFile, inspectCall }) : null
    );
...
function renderOfficial(props) {
  ...
  return React5.createElement(official.component, forwarded);
}
function FoldedSeat2() {
  return React5.createElement("div", { "data-tool-group-hidden": "" });
}
var AssistantNodeWrapper = React5.memo(function AssistantNodeWrapper2(props) {
  ...
  const thinkContent = group !== null && isGroupLeader(group, node.key) ? React5.createElement(
    React5.Fragment,
    null,
    React5.createElement(GroupBar, { group, expanded, onToggle: toggle, onKeyDown, t }),
    expanded ? React5.createElement(GroupItems, { group, t }) : null
  ) : null;
  let output;
  if (turnInfo !== null && isTurnSummary(turnInfo, node.key)) {
    ...
    if (!turnExpanded) {
      ...
      if (content === null) {
        output = first ? React5.createElement(TurnFoldBar, { expanded: true, onToggle: turnToggle, onKeyDown: turnKeyDown, t }) : React5.createElement(FoldedSeat2, null);
      } else {
