...
var AssistantNodeWrapper = React4.memo(function AssistantNodeWrapper2(props) {
  ...
  const thinkContent = group !== null && isGroupLeader(group, node.key) ? React4.createElement(
    React4.Fragment,
    null,
    React4.createElement(GroupBar, { group, expanded, onToggle: toggle, onKeyDown, t }),
    expanded ? React4.createElement(GroupItems, { group, t }) : null
  ) : null;
  ...
  if (turnInfo !== null && isProcessNode(turnInfo, node.key)) {
    ...
    if (content === null) {
      return first ? React4.createElement(TurnFoldBar, { expanded: true, onToggle: turnToggle, onKeyDown: turnKeyDown, t }) : React4.createElement(FoldedSeat2, null);
    }
  ...
  if (thinkContent === null) return React4.createElement(FoldedSeat2, null);
  return thinkContent;
});
export {
