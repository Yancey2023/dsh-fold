...
function projectUserText(text, sessionLabels = [], slashNames = [], slashKind = "skill", references) {
  ...
  while ((match = re.exec(text)) !== null) {
    ...
    const open = references === void 0 ? void 0 : chipKind === "file" ? () => references.openFile(name) : chipKind === "skill" ? () => references.openSkill(label.slice(1)) : void 0;
    parts.push(
      open === void 0 ? React.createElement("span", { key: `r${tokenStart}`, "data-ref-chip": chipKind }, contents) : React.createElement("button", { key: `r${tokenStart}`, type: "button", "data-ref-chip": chipKind, onClick: open }, contents)
    );
    ...
    React4.createElement(
      ...
      showBubble ? React4.createElement(
        ...
        React4.createElement(
          ...
          text !== "" ? projectUserText(text, data.referenceLabels ?? [], data.skillNames ?? [], "skill", references) : null,
          ...extraRest.map(
