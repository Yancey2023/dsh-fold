...
// ---------------------------------------------------------------------------
{
  ...
  // A settled think remains folded but no longer occupies the live left side.
  assert.ok(!text.includes('Think') && !text.includes('standalone'), 'settled think leaves the folded bar empty')
